...
void simulate_ball_motion(long long M, long long N, double x, double y, double r, double v, double alpha, double v_min, double t) {
    ...
    while (t > 0 && v >= v_min) { 
        ...
        double t_top = (v_y > 0) ? (-r - y) / v_y : INFINITY;
